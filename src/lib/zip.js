...
const crc32 = (()=>{
    ...
    return function crc32wrapper(input, crc) {
...
const compressions = (()=>{
    ...
    class FlateWorker extends GenericWorker {
        ...
        _createPako() {
            ...
            this._pako = this._pakoAction === 'Deflate' ? new pako.Deflate(params) : new pako.Inflate(params);
    ...
    class ZipEntry {
        ...
        findExtraFieldUnicodePath() {
            ...
            if (upathField) {
                ...
                if (crc32(this.fileName) !== extraReader.readInt(4)) {
                    return null;
                }
        ...
        findExtraFieldUnicodeComment() {
            ...
            if (ucommentField) {
                ...
                if (crc32(this.fileComment) !== extraReader.readInt(4)) {
                    return null;
                }
