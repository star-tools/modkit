...
export class EClassIdCAbil extends CEnum { static enum = ["CAbilUnknown","CAbil","CAbilProgress","CAbilEffect","CAbilQueueable","CAbilRedirect","CAbilArmMagazine","CAbilAttack","CAbilAugment","CAbilAttackModifier","CAbilBattery","CAbilBeacon","CAbilBehavior","CAbilBuild","CAbilBuildable","CAbilEffectInstant","CAbilEffectTarget","CAbilHarvest","CAbilInteract","CAbilInventory","CAbilLearn","CAbilMerge","CAbilMergeable","CAbilMorph","CAbilMorphPlacement","CAbilMove","CAbilPawn","CAbilQueue","CAbilRally","CAbilRedirectInstant","CAbilRedirectTarget","CAbilResearch","CAbilRevive","CAbilSpecialize","CAbilStop","CAbilTrain","CAbilTransport","CAbilWarpable","CAbilWarpTrain"]}
export class EClassIdCAccumulator extends CEnum { static enum = ["CAccumulatorUnknown","CAccumulator","CAccumulatorConstant","CAccumulatorVitals","CAccumulatorDistance","CAccumulatorBehavior","CAccumulatorAttributePoints","CAccumulatorTrackedUnitCount","CAccumulatorLevel","CAccumulatorAbilLevel","CAccumulatorUnitLevel","CAccumulatorVeterancyLevel","CAccumulatorCargo","CAccumulatorEffectAmount","CAccumulatorUserData","CAccumulatorUnitCustomValue","CAccumulatorSwitch","CAccumulatorArithmetic","CAccumulatorPlayerScoreValue"]}
export class EClassIdCAchievement extends CEnum { static enum = ["CAchievementUnknown","CAchievement"]}
export class EClassIdCAchievementTerm extends CEnum { static enum = ["CAchievementTermUnknown","CAchievementTerm","CAchievementTermAbil","CAchievementTermAbilInteract","CAchievementTermAbilLoad","CAchievementTermAbilUse","CAchievementTermAchievement","CAchievementTermBehavior","CAchievementTermBehaviorAbsorbed","CAchievementTermBehaviorCount","CAchievementTermBehaviorElapsed","CAchievementTermBehaviorState","CAchievementTermCombine","CAchievementTermEffect","CAchievementTermEffectAbsorbed","CAchievementTermEffectDamaged","CAchievementTermEffectDodged","CAchievementTermEffectHealed","CAchievementTermEffectKilled","CAchievementTermEffectUse","CAchievementTermGeneric","CAchievementTermReplay","CAchievementTermScoreValue","CAchievementTermTime","CAchievementTermUnit","CAchievementTermUnitBirth","CAchievementTermUnitDeath","CAchievementTermUnitKills","CAchievementTermUnitRegen","CAchievementTermUnitSupplyLoss"]}
export class EClassIdCActor extends CEnum { static enum = ["CActorUnknown","CActor","CActorBase","CActorBearings","CActorCamera","CActorModel","CActorModelMaterial","CActorQuad","CActorForce","CActorForceLineSegment","CActorBeam","CActorRange","CActorRegion","CActorSite","CActorSiteOp","CActorSiteOpBase","CActorSound","CActorSplat","CActorAction","CActorActionOverride","CActorArc","CActorBeamSimple","CActorBeamStandard","CActorBlob","CActorCameraModel","CActorCreep","CActorCutscene","CActorDoodad","CActorDoodadPreserver","CActorFoliageFXSpawner","CActorEditorCamera","CActorEditorPoint","CActorEventMacro","CActorEventMacroRunnable","CActorForceBox","CActorForceConeRoundedEnd","CActorForceCylinder","CActorForceSphere","CActorGlobalConfig","CActorOverrides","CActorLight","CActorLightOmni","CActorLightSpot","CActorLightModel","CActorLightOmniModel","CActorLightSpotModel","CActorLookAt","CActorList","CActorListPerPlayer","CActorPortrait","CActorPower","CActorProgress","CActorPropertyCurveSet","CActorQueryResponse","CActorRegionArc","CActorRegionCircle","CActorRegionCombine","CActorRegionGame","CActorRegionPolygon","CActorRegionQuad","CActorRegionWater","CActorScene","CActorSelection","CActorSetQueried","CActorShadow","CActorShield","CActorShieldImpact","CActorSimple","CActorSiteBillboard","CActorSiteMover","CActorSiteOrbiter","CActorSiteRocker","CActorSiteOp2DRotation","CActorSiteOpAction","CActorSiteOpAttach","CActorSiteOpAttachVolume","CActorSiteOpBanker","CActorSiteOpBankerUnit","CActorSiteOpBasic","CActorSiteOpGameCameraFollow","CActorSiteOpDeathMotion","CActorSiteOpDeltaSum","CActorSiteOpEffect","CActorSiteOpForward","CActorSiteOpHeight","CActorSiteOpHigherOfTerrainAndWater","CActorSiteOpHostBearings","CActorSiteOpHostedOffset","CActorSiteOpIncoming","CActorSiteOpLocalOffset","CActorSiteOpOrientAttachPointTo","CActorSiteOpPatch","CActorSiteOpPersistentOffset","CActorSiteOpOrbiter","CActorSiteOpPhysicsImpact","CActorSiteOpRandomPointInCircle","CActorSiteOpRandomPointInCrossbar","CActorSiteOpRandomPointInSphere","CActorSiteOpRotationExplicit","CActorSiteOpRotationRandom","CActorSiteOpRotationVariancer","CActorSiteOpRotator","CActorSiteOpRotationSmooth","CActorSiteOpSelectionOffset","CActorSiteOpSerpentHead","CActorSiteOpSerpentSegment","CActorSiteOpShadow","CActorSiteOpTether","CActorSiteOpTipability","CActorSiteOpTilter","CActorSiteOpUp","CActorSiteOpZ","CActorSiteOpCursor","CActorSiteOpYawLimiter","CActorSiteOpPitchLimiter","CActorSnapshot","CActorStateMonitor","CActorSquib","CActorBatch","CActorTerrain","CActorTerrainDeformer","CActorText","CActorTurret","CActorUnit","CActorUnitRing","CActorMissile","CActorMinimap"]}
export class EClassIdCActorSupport extends CEnum {static enum = ["CActorSupportUnknown"]}
export class EClassIdCAlert extends CEnum { static enum = ["CAlerUnknown","CAlertUnknown","CAlert"]}
export class EClassIdCArmyCategory extends CEnum { static enum = ["CArmyCategoryUnknown","CArmyCategory"]}
export class EClassIdCArmyUnit extends CEnum { static enum = ["CArmyUnitUnknown","CArmyUnit"]}
export class EClassIdCArmyUpgrade extends CEnum { static enum = ["CArmyUpgradeUnknown","CArmyUpgrade"]}
export class EClassIdCArtifact extends CEnum { static enum = ["CArtifactUnknown","CArtifact"]}
export class EClassIdCArtifactSlot extends CEnum { static enum = ["CArtifactSlotUnknown","CArtifactSlot"]}
export class EClassIdCAttachMethod extends CEnum { static enum = ["CAttachMethodUnknown","CAttachMethod","CAttachMethodArcTest","CAttachMethodBestMatch","CAttachMethodFilter","CAttachMethodAttachType","CAttachMethodIncoming","CAttachMethodLeastDeflection","CAttachMethodNodeOccupancy","CAttachMethodNodeOccupancy2","CAttachMethodNumericField","CAttachMethodPattern","CAttachMethodPortAllocator","CAttachMethodProximity","CAttachMethodRandom","CAttachMethodReduction","CAttachMethodVolumesRequery","CAttachMethodVolumesTargets","CAttachMethodVolumesWeightedPick"]}
export class EClassIdCBankCondition extends CEnum { static enum = ["CBankConditionUnknown","CBankCondition","CBankConditionCompare","CBankConditionCompareValueCount","CBankConditionCompareValueInteger","CBankConditionCompareValueString","CBankConditionCompareValueSum","CBankConditionCombine","CBankConditionCurrentMap"]}
export class EClassIdCBeam extends CEnum { static enum = ["CBeamUnknown","CBeam","CBeamSync","CBeamSyncSweeper","CBeamAsync","CBeamAsyncLinear","CBeamAsyncShadow"]}
export class EClassIdCBehavior extends CEnum { static enum = ["CBehaviorUnknown","CBehavior","CBehaviorAttackModifier","CBehaviorAttribute","CBehaviorUnitTracker","CBehaviorBuff","CBehaviorClickResponse","CBehaviorConjoined","CBehaviorCreepSource","CBehaviorJump","CBehaviorPowerSource","CBehaviorPowerUser","CBehaviorResource","CBehaviorReveal","CBehaviorSpawn","CBehaviorVeterancy","CBehaviorWander"]}
export class EClassIdCBoost extends CEnum { static enum = ["CBoostUnknown","CBoost"]}
export class EClassIdCBundle extends CEnum { static enum = ["CBundleUnknown","CBundle"]}
export class EClassIdCButton extends CEnum { static enum = ["CButtonUnknown","CButton"]}
export class EClassIdCCamera extends CEnum { static enum = ["CCameraUnknown","CCamera"]}
export class EClassIdCCampaign extends CEnum { static enum = ["CCampaignUnknown","CCampaign"]}
export class EClassIdCCharacter extends CEnum { static enum = ["CCharacterUnknown","CCharacter"]}
export class EClassIdCCliff extends CEnum { static enum = ["CCliffUnknown","CCliff"]}
export class EClassIdCCliffMesh extends CEnum { static enum = ["CCliffMeshUnknown","CCliffMesh"]}
export class EClassIdCColorStyle extends CEnum { static enum = ["CColorStyleUnknown","CColorStyle"]}
export class EClassIdCCommander extends CEnum { static enum = ["CCommanderUnknown","CCommander"]}
export class EClassIdCConfig extends CEnum { static enum = ["CConfigUnknown","CConfig"]}
export class EClassIdCConsoleSkin extends CEnum { static enum = ["CConsoleSkinUnknown","CConsoleSkin"]}
export class EClassIdCConversation extends CEnum { static enum = ["CConversationUnknown","CConversation"]}
export class EClassIdCConversationState extends CEnum { static enum = ["CConversationStateUnknown","CConversationState"]}
export class EClassIdCCursor extends CEnum { static enum = ["CCursorUnknown","CCursor"]}
export class EClassIdCDataCollection extends CEnum { static enum = ["CDataCollectionUnknown","CDataCollection","CDataCollectionUnit","CDataCollectionUpgrade","CDataCollectionAbil"]}
export class EClassIdCDataCollectionPattern extends CEnum { static enum = ["CDataCollectionPatternUnknown","CDataCollectionPattern"]}
export class EClassIdCDecalPack extends CEnum { static enum = ["CDecalPackUnknown","CDecalPack"]}
export class EClassIdCDSP extends CEnum { static enum = ["CDSPUnknown","CDSP","CDSPChorus","CDSPCompressor","CDSPCustomCompressor","CDSPDistortion","CDSPEcho","CDSPFlange","CDSPHighPass","CDSPLimiter","CDSPLowPass","CDSPLowPassSimple","CDSPNormalize","CDSPOscillator","CDSPParamEQ","CDSPPitchShift","CDSPReverb"]}
export class EClassIdCEffect extends CEnum { static enum = ["CEffectUnknown","CEffect","CEffectResponse","CEffectAddTrackedUnit","CEffectClearTrackedUnits","CEffectAddTrackedUnits","CEffectRemoveTrackedUnit","CEffectApplyBehavior","CEffectApplyForce","CEffectApplyKinetic","CEffectCancelOrder","CEffectCreateHealer","CEffectCreep","CEffectCreatePersistent","CEffectRandomPointInCircle","CEffectCreateUnit","CEffectDamage","CEffectDestroyHealer","CEffectDestroyPersistent","CEffectEnumArea","CEffectEnumTrackedUnits","CEffectEnumMagazine","CEffectEnumTransport","CEffectEnumInventory","CEffectLastTarget","CEffectLoadContainer","CEffectIssueOrder","CEffectLaunchMissile","CEffectModifyPlayer","CEffectModifyUnit","CEffectMorph","CEffectRedirectMissile","CEffectReleaseMagazine","CEffectRemoveBehavior","CEffectRemoveKinetic","CEffectReturnMagazine","CEffectSet","CEffectSwitch","CEffectTeleport","CEffectTransferBehavior","CEffectUseCalldown","CEffectUseMagazine","CEffectUserData"]}
export class EClassIdCEmoticon extends CEnum { static enum = ["CEmoticonUnknown","CEmoticon"]}
export class EClassIdCEmoticonPack extends CEnum { static enum = ["CEmoticonPackUnknown","CEmoticonPack"]}
export class EClassIdCError extends CEnum {static enum = ["CErrorUnknown"]}
export class EClassIdCFootprint extends CEnum { static enum = ["CFootprintUnknown","CFootprint"]}
export class EClassIdCFoW extends CEnum { static enum = ["CFoWUnknown","CFoW"]}
export class EClassIdCGame extends CEnum { static enum = ["CGameUnknown","CGame"]}
export class EClassIdCGameUI extends CEnum { static enum = ["CGameUIUnknown","CGameUI"]}
export class EClassIdCHerd extends CEnum { static enum = ["CHerdUnknown","CHerd"]}
export class EClassIdCHerdNode extends CEnum { static enum = ["CHerdNodeUnknown","CHerdNode"]}
export class EClassIdCHero extends CEnum { static enum = ["CHeroUnknown","CHero"]}
export class EClassIdCHeroAbil extends CEnum { static enum = ["CHeroAbilUnknown","CHeroAbil"]}
export class EClassIdCHeroStat extends CEnum { static enum = ["CHeroStatUnknown","CHeroStat"]}
export class EClassIdCItem extends CEnum { static enum = ["CItemUnknown","CItem","CItemAbil","CItemAbilPowerUp","CItemEffect","CItemEffectInstant","CItemEffectTarget"]}
export class EClassIdCItemClass extends CEnum { static enum = ["CItemClassUnknown","CItemClass"]}
export class EClassIdCItemContainer extends CEnum { static enum = ["CItemContainerUnknown","CItemContainer"]}
export class EClassIdCKinetic extends CEnum { static enum = ["CKineticUnknown","CKinetic","CKineticFollow","CKineticRotate","CKineticSequence","CKineticSet","CKineticTranslate","CKineticDistance"]}
export class EClassIdCLensFlareSet extends CEnum { static enum = ["CLensFlareSetUnknown","CLensFlareSet"]}
export class EClassIdCLight extends CEnum { static enum = ["CLightUnknown","CLight"]}
export class EClassIdCLocation extends CEnum { static enum = ["CLocationUnknown","CLocation"]}
export class EClassIdCLoot extends CEnum { static enum = ["CLootUnknown","CLoot","CLootSpawn","CLootEffect","CLootItem","CLootSet","CLootUnit"]}
export class EClassIdCMap extends CEnum { static enum = ["CMapUnknown","CMap"]}
export class EClassIdCModel extends CEnum { static enum = ["CModelUnknown","CModel","CModelFoliage"]}
export class EClassIdCMount extends CEnum { static enum = ["CMountUnknown","CMount"]}
export class EClassIdCMover extends CEnum { static enum = ["CMoverUnknown","CMover","CMoverAvoid","CMoverFlock","CMoverMissile","CMoverNull"]}
export class EClassIdCObjective extends CEnum { static enum = ["CObjectiveUnknown","CObjective"]}
export class EClassIdCPhysicsMaterial extends CEnum { static enum = ["CPhysicsMaterialUnknown","CPhysicsMaterial"]}
export class EClassIdCPing extends CEnum { static enum = ["CPingUnknown","CPing"]}
export class EClassIdCPlayerResponse extends CEnum { static enum = ["CPlayerResponseUnknown","CPlayerResponse","CPlayerResponseUnit","CPlayerResponseUnitDamage","CPlayerResponseUnitDeath","CPlayerResponseUnitBirth"]}
export class EClassIdCPortraitPack extends CEnum { static enum = ["CPortraitPackUnknown","CPortraitPack"]}
export class EClassIdCPreload extends CEnum { static enum = ["CPreloadUnknown","CPreload","CPreloadAsset","CPreloadScene","CPreloadActor","CPreloadConversation","CPreloadModel","CPreloadSound","CPreloadUnit"]}
export class EClassIdCPremiumMap extends CEnum { static enum = ["CPremiumMapUnknown","CPremiumMap"]}
...
export class EClassIdCScoreValue extends CEnum { static enum = ["CScoreValueUnknown","CScoreValue","CScoreValueCustom","CScoreValueStandard","CScoreValueConstant","CScoreValueCombine"]}
export class EClassIdCShape extends CEnum { static enum = ["CShapeUnknown","CShape","CShapeArc","CShapeQuad"]}
export class EClassIdCSkin extends CEnum { static enum = ["CSkinUnknown","CSkin"]}
export class EClassIdCSkinPack extends CEnum { static enum = ["CSkinPackUnknown","CSkinPack"]}
export class EClassIdCSound extends CEnum { static enum = ["CSoundUnknown","CSound"]}
export class EClassIdCSoundExclusivity extends CEnum { static enum = ["CSoundExclusivityUnknown","CSoundExclusivity"]}
export class EClassIdCSoundMixSnapshot extends CEnum { static enum = ["CSoundMixSnapshotUnknown","CSoundMixSnapshot"]}
export class EClassIdCSoundtrack extends CEnum { static enum = ["CSoundtrackUnknown","CSoundtrack"]}
export class EClassIdCSpray extends CEnum { static enum = ["CSprayUnknown","CSpray"]}
export class EClassIdCSprayPack extends CEnum { static enum = ["CSprayPackUnknown","CSprayPack"]}
export class EClassIdCStimPack extends CEnum { static enum = ["CStimPackUnknown","CStimPack"]}
export class EClassIdCTacCooldown extends CEnum { static enum = ["CTacCooldownUnknown","CTacCooldown"]}
export class EClassIdCTactical extends CEnum { static enum = ["CTacticalUnknown","CTactical","CTacticalOrder","CTacticalSet"]}
export class EClassIdCTalent extends CEnum { static enum = ["CTalentUnknown","CTalent"]}
export class EClassIdCTalentProfile extends CEnum { static enum = ["CTalentProfileUnknown","CTalentProfile"]}
export class EClassIdCTargetFind extends CEnum { static enum = ["CTargetFindUnknown","CTargetFind","CTargetFindBestPoint","CTargetFindWorkerRallyPoint","CTargetFindRallyPoint","CTargetFindEnumArea","CTargetFindEffect","CTargetFindLastAttacker","CTargetFindOffset","CTargetFindOrder","CTargetFindSet"]}
